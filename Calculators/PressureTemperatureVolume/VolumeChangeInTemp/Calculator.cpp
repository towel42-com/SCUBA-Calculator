...
TVariableInfoList CCalculator::getMyVariables( bool *preReversed ) const
{
    *preReversed = true;
    ...
    auto retVal = TVariableInfoList( {
        CVariableInfo::create( "v1", tr( "Volume 1" ), EUnit::eVolume, EVariableLoc::eRHS ),   //
        CVariableInfo::create( "t1", tr( "Temperature 1" ), EUnit::eAbsZeroTemperature, EVariableLoc::eRHS ),   //
        CVariableInfo::create( "v2", tr( "Volume 2" ), EUnit::eVolume, EVariableLoc::eLHS ),   //
